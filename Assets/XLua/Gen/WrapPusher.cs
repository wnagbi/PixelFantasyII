...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<PlayerStateType>(translator.PushPlayerStateType, translator.Get, translator.UpdatePlayerStateType);
				translator.RegisterPushAndGetAndUpdate<EnemyStateType>(translator.PushEnemyStateType, translator.Get, translator.UpdateEnemyStateType);
				translator.RegisterPushAndGetAndUpdate<PickUpTpye>(translator.PushPickUpTpye, translator.Get, translator.UpdatePickUpTpye);
        ...
        int PlayerStateType_TypeID = -1;
		int PlayerStateType_EnumRef = -1;
        
        public void PushPlayerStateType(RealStatePtr L, PlayerStateType val)
        {
            if (PlayerStateType_TypeID == -1)
            {
			    bool is_first;
                PlayerStateType_TypeID = getTypeId(L, typeof(PlayerStateType), out is_first);
				
				if (PlayerStateType_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(PlayerStateType));
				    PlayerStateType_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, PlayerStateType_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, PlayerStateType_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for PlayerStateType ,value="+val);
            }
			
			LuaAPI.lua_getref(L, PlayerStateType_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out PlayerStateType val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != PlayerStateType_TypeID)
				{
				    throw new Exception("invalid userdata for PlayerStateType");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for PlayerStateType");
                }
				val = (PlayerStateType)e;
                
            }
            else
            {
                val = (PlayerStateType)objectCasters.GetCaster(typeof(PlayerStateType))(L, index, null);
            }
        }
		
        public void UpdatePlayerStateType(RealStatePtr L, int index, PlayerStateType val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for PlayerStateType ,value="+val);
                }
            }
        ...
        int EnemyStateType_TypeID = -1;
		int EnemyStateType_EnumRef = -1;
        
        public void PushEnemyStateType(RealStatePtr L, EnemyStateType val)
        {
            if (EnemyStateType_TypeID == -1)
            {
			    bool is_first;
                EnemyStateType_TypeID = getTypeId(L, typeof(EnemyStateType), out is_first);
				
				if (EnemyStateType_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(EnemyStateType));
				    EnemyStateType_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, EnemyStateType_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, EnemyStateType_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for EnemyStateType ,value="+val);
            }
			
			LuaAPI.lua_getref(L, EnemyStateType_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out EnemyStateType val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != EnemyStateType_TypeID)
				{
				    throw new Exception("invalid userdata for EnemyStateType");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for EnemyStateType");
                }
				val = (EnemyStateType)e;
                
            }
            else
            {
                val = (EnemyStateType)objectCasters.GetCaster(typeof(EnemyStateType))(L, index, null);
            }
        }
		
        public void UpdateEnemyStateType(RealStatePtr L, int index, EnemyStateType val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for EnemyStateType ,value="+val);
                }
            }
        ...
        int PickUpTpye_TypeID = -1;
		int PickUpTpye_EnumRef = -1;
        
        public void PushPickUpTpye(RealStatePtr L, PickUpTpye val)
        {
            if (PickUpTpye_TypeID == -1)
            {
			    bool is_first;
                PickUpTpye_TypeID = getTypeId(L, typeof(PickUpTpye), out is_first);
				
				if (PickUpTpye_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(PickUpTpye));
				    PickUpTpye_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, PickUpTpye_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, PickUpTpye_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for PickUpTpye ,value="+val);
            }
			
			LuaAPI.lua_getref(L, PickUpTpye_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out PickUpTpye val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != PickUpTpye_TypeID)
				{
				    throw new Exception("invalid userdata for PickUpTpye");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for PickUpTpye");
                }
				val = (PickUpTpye)e;
            ...
            {
                val = (PickUpTpye)objectCasters.GetCaster(typeof(PickUpTpye))(L, index, null);
            }
        }
		
        public void UpdatePickUpTpye(RealStatePtr L, int index, PickUpTpye val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for PickUpTpye ,value="+val);
                }
            }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			else if (type == typeof(PlayerStateType[]))
			{
			    PlayerStateType[] array = obj as PlayerStateType[];
				translator.PushPlayerStateType(L, array[index]);
				return true;
			}
			else if (type == typeof(EnemyStateType[]))
			{
			    EnemyStateType[] array = obj as EnemyStateType[];
				translator.PushEnemyStateType(L, array[index]);
				return true;
			}
			else if (type == typeof(PickUpTpye[]))
			{
			    PickUpTpye[] array = obj as PickUpTpye[];
				translator.PushPickUpTpye(L, array[index]);
				return true;
			}
            return false;
		}
