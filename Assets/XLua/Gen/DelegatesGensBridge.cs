...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp4(object p0, float p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp5(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp6(object p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<object>(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(System.Action<object, float>))
			{
			    return new System.Action<object, float>(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(System.Func<object, bool>))
			{
			    return new System.Func<object, bool>(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(System.Func<object, int, bool>))
			{
			    return new System.Func<object, int, bool>(__Gen_Delegate_Imp6);
			}
